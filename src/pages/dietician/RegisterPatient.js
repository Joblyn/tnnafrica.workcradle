...
export default function PatientSignUp() {
  ...
  let companyCode = dietitian.companyCode;
  ...
  useEffect(() => {
    ...
    } else if ((createPatientState.isCreated === false) && submitted) {
      ...
      {success && (
        <Container fluid className="px-0 sticky-top">
          <Alert className="mb-0 text-center">
            <i className="fa fa-info mx-2"></i>Created Patient Successfully!
          </Alert>
        </Container>
      )}
      <Col
